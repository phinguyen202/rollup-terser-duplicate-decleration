...
var height$1 = 32.91;
function JSX$1(_a) {
    var _b = _a.up, up = _b === void 0 ? true : _b;
...
var height$2 = 40;
function JSX$2(_a) {
    var _b = _a.x, x = _b === void 0 ? 0 : _b, _c = _a.y, y = _c === void 0 ? 0 : _c, _d = _a.isStemUp, isStemUp = _d === void 0 ? true : _d;
...
var SvgMusicNotation = /** @class */ (function (_super) {
    ...
    SvgMusicNotation.prototype.render = function () {
        return (React.createElement("svg", { width: 500, height: 500 },
            React.createElement(TrebleClef.JSX, null),
            React.createElement(QuarterNote.JSX, { x: 50, y: 20 })));
    };
